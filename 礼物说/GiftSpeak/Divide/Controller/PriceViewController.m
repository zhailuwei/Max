...
@interface PriceViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
- (void)createCollect
{
    ...
    [_collect release];
    [_collect registerClass:[PriceCell class] forCellWithReuseIdentifier:@"position"];
}
...
{
    PriceCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"position" forIndexPath:indexPath];
