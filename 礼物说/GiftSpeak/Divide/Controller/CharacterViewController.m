...
@interface CharacterViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
- (void)myConnection
{
    ...
    [dic setObject:@"0_50" forKey:@"price"];
...
- (void)createCollect
{
    ...
    [_collect release];
    [_collect registerClass:[CharacterCell class] forCellWithReuseIdentifier:@"position"];
}
...
{
    CharacterCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"position" forIndexPath:indexPath];
